# -*- coding: utf-8 -*-
#
# Snorkel documentation build configuration file, created by
# sphinx-quickstart on Mon Sep  5 12:49:28 2016.
#
...
project = u'Snorkel'
copyright = u'2016, Alex Ratner, Stephen Bach, Henry Ehrenberg'
...
latex_documents = [
  ('index', 'Snorkel.tex', u'Snorkel Documentation',
   u'Alex Ratner, Stephen Bach, Henry Ehrenberg', 'manual'),
]
...
man_pages = [
    ('index', 'snorkel', u'Snorkel Documentation',
     [u'Alex Ratner, Stephen Bach, Henry Ehrenberg'], 1)
]
...
texinfo_documents = [
  ('index', 'Snorkel', u'Snorkel Documentation',
   u'Alex Ratner, Stephen Bach, Henry Ehrenberg', 'Snorkel', 'One line description of project.',
   'Miscellaneous'),
]
