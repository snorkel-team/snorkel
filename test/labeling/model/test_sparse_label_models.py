...
from snorkel.labeling.model.sparse_label_model.base_sparse_example_eventlist_label_model import \
...
from snorkel.labeling.model.sparse_label_model.sparse_event_pair_label_model import SparseEventPairLabelModel
...
class SparseExampleEventListLabelModelTest(SparseModelTestCase):
    def test_sparse_and_regular_make_same_l_ind_and_o(self):
        ...
        sparse_model._set_constants(known_dimensions=self.known_dimensions)
        sparse_model_lind =sparse_model.get_l_ind(known_dimensions=self.known_dimensions,example_events_list=example_event_lists,return_array=True)
        sparse_model_objective = sparse_model._prepare_objective_from_sparse_example_eventlist(known_dimensions=self.known_dimensions,example_events_list=example_event_lists)
