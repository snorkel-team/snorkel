...
from snorkel.mtl.utils import list_to_tensor, pad_batch
...
class DatasetTest(unittest.TestCase):
    def test_pad_batch(self):
        ...
        self.assertTure(torch.equal(mask_batch, torch.Tensor([[0, 0], [0, 1], [0, 0]])))
        ...
        self.assertTure(torch.equal(mask_batch, torch.Tensor([[0, 0], [1, 0], [0, 0]])))
