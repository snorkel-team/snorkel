...
class CDRTagger(object):
    ...
    def __init__(self, fname='tutorials/cdr/data/unary_tags.pkl.bz2'):
...
class TaggerOneTagger(CDRTagger):
    # def __init__(self,
    #              fname_tags='tutorials/cdr/data/taggerone_unary_tags_cdr.pkl.bz2',
    #              fname_mesh='tutorials/cdr/data/chem_dis_mesh_dicts.pkl.bz2'):
